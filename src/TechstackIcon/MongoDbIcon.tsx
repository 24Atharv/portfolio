import mongoIcon from '../assets/icon.png'

export const MongoDbIcon = () => {
    return <div className="flex justify-center items-center gap-2 px-2 py-2 bg-gray-700 rounded">
        {/* <img src={mongoIcon} height="24px" width="24px" alt="" /> */}
